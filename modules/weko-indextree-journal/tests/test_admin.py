...
class TestIndexJournalSettingView:
    ...
    def test_index_acl(self, app, db, client_rest, users, test_indices, test_journals, id, is_permission):
        with patch("weko_indextree_journal.admin.IndexJournalSettingView.render",return_value=make_response()):
    ...
    def test_index(self, app, db,client_rest, users,test_indices, test_journals):
        ...
        # not lists
        with patch("weko_indextree_journal.admin.IndexJournalSettingView.render",return_value=make_response()) as mock_render:
            res = client_rest.get(url)
            assert res.status_code == 200
    ...
    def test_get_schema_form(self,app,client_rest,db,users,test_indices, mocker):
        ...
        mocker.patch("weko_indextree_journal.admin.current_i18n",mocker.Mock(language="ja"))
