...
WEKO_WORKFLOW_MESSAGE = {
    'WEKO_WORKFLOW_FAILED_SAVE': {
        ...
        'msgstr': "FAILED to save worfflow: %(workflow_id)s",
        'loglevel': 'ERROR',
    },
    ...
    'WEKO_WORKFLOW_FAILED_SAVE_METADATA': {
        ...
        'msgstr': "FAILED to save Metadata: %(pid)s",
        'loglevel': 'ERROR',
    },
    ...
    'WEKO_WORKFLOW_SAVED_METADATA': {
        ...
        'msgstr': "Metadata saved: %(pid)s",
        'loglevel': 'INFO',
    },
    'WEKO_WORKFLOW_QUIT_METADATA': {
        'msgid': 'WEKO_WORKFLOW_I_0012',
        'msgstr': "Metadata input was quitted: %(pid)s",
        'loglevel': 'INFO',
    },
