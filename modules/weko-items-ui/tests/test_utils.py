...
def test_validate_user(users, db_userprofile):
    ...
    expected_username = db_userprofile[user_email].get_username
    ...
    response_valid = validate_user(expected_username, user_email)
    assert response_valid == expected_response_valid, f"Expected {expected_response_valid}, but got {response_valid}"
