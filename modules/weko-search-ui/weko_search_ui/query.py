...
def range_query(now, _from=None, _until=None):
    ...
    must_not_embargoed = Q('bool', must_not=[Q('term', accessRights='embargoed access')])
    must_not_content_accessrole = Q('bool', must_not=[Q('nested', path='content', query=Q('exists', field='content.accessrole.raw'))])
    must_not_open_access = Q('nested', path='content', query=Q('bool', must_not=[
        Q('term', **{'content.accessrole.raw': 'open_access'}),
        Q('bool', must=[
            Q('term', **{'content.accessrole.raw': 'open_date'}),
            Q('range', **{'content.date.dateValue.raw': {'lte': now}})
    ...
    should1 = Q('bool', must=[
        Q('bool', should=[must_not_embargoed, must_not_content_accessrole, must_not_open_access]),
        Q('range', **{
            '_updated': {
    ...
    must_not_open_access2 = Q('nested', path='content', query=Q('bool', must_not=[
        Q('term', **{'content.accessrole.raw': 'open_access'}),
        Q('bool', must=[
            Q('term', **{'content.accessrole.raw': 'open_date'}),
            Q('range', **{'content.date.dateValue.raw': {'lte': now}})
    ...
    from_should = []
    if _from:
        from_should.append(Q('nested', path='content', query=Q('bool', must=[
            Q('term', **{'content.accessrole.raw': 'open_date'}),
    ...
    until_must = []
    if _until:
        until_must.append(Q('bool', must_not=[
            Q('nested', path='content', query=Q('bool', must=[
                Q('term', **{'content.accessrole.raw': 'open_date'}),
