...
def base_app(instance_path, search_class, request):
    ...
    app_.config.update(
        ...
        WEKO_MIMETYPE_WHITELIST_FOR_SEARCH = WEKO_MIMETYPE_WHITELIST_FOR_SEARCH,
        WEKO_DEPOSIT_TEXTMIMETYPE_WHITELIST_FOR_SEARCH = WEKO_DEPOSIT_TEXTMIMETYPE_WHITELIST_FOR_SEARCH,
