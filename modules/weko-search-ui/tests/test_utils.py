...
# .tox/c1/bin/pytest --cov=weko_search_ui tests/test_utils.py::test_combine_aggs -v -vv -s --cov-branch --cov-report=term --basetemp=/code/modules/weko-search-ui/.tox/c1/tmp
def test_combine_aggs():
