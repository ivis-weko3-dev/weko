...
from weko_deposit.config import (
    ...
    WEKO_DEPOSIT_TEXTMIMETYPE_WHITELIST_FOR_SEARCH as _WEKO_DEPOSIT_TEXTMIMETYPE_WHITELIST_FOR_SEARCH,
)
...
def base_app(instance_path):
    ...
    app_.config.update(
        ...
        WEKO_DEPOSIT_TEXTMIMETYPE_WHITELIST_FOR_SEARCH = _WEKO_DEPOSIT_TEXTMIMETYPE_WHITELIST_FOR_SEARCH,
