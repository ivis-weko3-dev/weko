...
WEKO_GROUPS_MESSAGE = {
    ...
    'WEKO_GROUPS_INVITE_USER_TO_GROUP': {
        ...
        'msgstr': "Invite user %(user_id)s to group %(group_id)s",
        'loglevel': 'INFO',
    },
}
